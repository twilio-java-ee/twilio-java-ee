...
import com.twilio.ee.cdi.extension.util.KeyValue;
         ...
         implements Extension
{
         ...
         if (stream != null)
         {
            try
            {
               ...
               if (props.containsKey(TWILIO_ACCOUNT_KEY))
               {
                  ...
                  {
                     Account account = new Account(name.trim().toLowerCase());
   ...
   private static void in(KeyValue keyValue, Map<String, Account> accounts) throws Exception
   {
